...
export type SubtitleBackground = 'none' | 'solid' | 'rounded_box' | 'active_word_pill'
export type SubtitleFont = 'impact' | 'bebas' | 'montserrat' | 'sora' | 'arial_black' | 'trebuchet' | 'verdana' | 'georgia' | 'times_new_roman' | 'comic_sans' | 'cooper_black' | 'arial_rounded' | 'lucida_handwriting' | 'brush_script' | 'papyrus'
