...
export default function AccountMenu() {
  ...
  return (
    <div ref={menuRef} className="relative flex items-center gap-3 text-right">
      ...
      {open && (
        <div className="fixed inset-0 z-[9999] flex items-start justify-center bg-black/55 px-3 py-6 backdrop-blur-sm sm:items-center sm:py-8">
          <div className="liquid-card top-origin-popover max-h-[calc(100vh-3rem)] w-[min(25rem,calc(100vw-1.5rem))] overflow-y-auto p-4 text-left shadow-2xl shadow-black/50">
